					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="register.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								...
								style="<?php echo empty($emailError) ? '' : 'border:1px solid red;';?>"placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'">
							</div>
							...
							<div class="col-md-12 form-group">
								...
								style="<?php echo empty($passwordError) ? '' : 'border:1px solid red;';?>"placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
